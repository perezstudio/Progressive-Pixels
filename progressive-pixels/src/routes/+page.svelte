...
<section>
    <h1>A design agency tailored for your cause</h1>
    <p>The Unlimited Design Subscription Service for Political Campaigns, Parties, and Nonprofits.</p>
    <a href="/contact"><p>Sign Up for Early Access</p></a>
</section>
<section>
    <div>
        <div>
            <p>Membership Benefits</p>
            <h2>Unmatched Perks for Members</h2>
