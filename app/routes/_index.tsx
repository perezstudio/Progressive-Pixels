      ...
      <section className="px-8 py-20 flex flex-row justify-center">
        <div className="flex flex-col gap-8 max-w-1200 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <PricingCard type="design" heading="Design Essentials" dollarAmount="199" centsAmount=".99" features={['Unlimited Revisions', '1-2 day turnaround*', 'One request at a time', 'Unlimited Brands', 'Unlimited Users']} included={['Unlimited Revisions', '1-2 day turnaround*', 'One request at a time', 'Unlimited Brands', 'Unlimited Users']} />
            <PricingCard type="social" heading="Social Media" dollarAmount="199" centsAmount=".99" features={['Content Creation', 'Post Scheduling', 'Platform-Specific Designs', 'Event & Campaign Graphics', 'Monthly Analytics Report']} included={['Unlimited Revisions', '1-2 day turnaround*', 'One request at a time', 'Unlimited Brands', 'Unlimited Users']} />
            <PricingCard type="web" heading="Web Studio" dollarAmount="199" centsAmount=".99" features={['Web design', 'Webflow site development', 'Email design', 'Static web assets', 'Content editing']} included={['Unlimited Revisions', 'Domain & Hosting - 1 site', 'One request at a time', 'Unlimited Brands', 'Unlimited Users']} />
            <PricingCard type="bundle" heading="Creative Agency Bundle" dollarAmount="449" centsAmount=".99" features={['Unlimited Revisions', '1-2 day turnaround*', 'One request at a time', 'Unlimited Brands', 'Unlimited Users']} included={['Design Essentials', 'Social Media', 'Web Digital']} />
